...
const Experience: React.FC<{}> = () => {
  return (
    ...
    >
      ...
      >
        <div className="w-screen flex  flex-col lg:justify-between justify-center p-10">
          ...
          <p className="text-gray-300 pt-6 gap-5 ">
        ...
        <div className=" flex gap-2 flex-col animate-pulse  items-center w-full ">
